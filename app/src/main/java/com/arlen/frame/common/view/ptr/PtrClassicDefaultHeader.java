package com.arlen.frame.common.view.ptr;
...
public class PtrClassicDefaultHeader extends FrameLayout implements PtrUIHandler {
    ...
    private final static byte PTR_STATUS_PREPARE = 2;
    private final static byte PTR_STATUS_LOADING = 3;
    private final static byte PTR_STATUS_COMPLETE = 4;
    ...
    public void setHeaderView(int type){
//        if(type == 0) {
//            //猪猪快购
//            mProgressBar.setImageResource(R.drawable.anim_refresh_head);
//        }else if(type == 1){
//            //二手市场
//            mProgressBar.setImageResource(R.drawable.anim_refresh_head2);
//        }
...
//        animation.stop();
        ...
        if (getPtrUIHandler()!=null){
            getPtrUIHandler().onUIRefreshPrepare(frame);
        }
    }
...
//        animation.start();
        ...
        if (getPtrUIHandler()!=null){
            getPtrUIHandler().onUIRefreshBegin(frame);
        }
    }
...
//        animation.stop();
        ...
        if (getPtrUIHandler()!=null){
            getPtrUIHandler().onUIRefreshComplete(frame);
        }
    }
...
//                    mRotateView.startAnimation(mFlipAnimation);
        ...
        if (getPtrUIHandler()!=null){
            getPtrUIHandler().onUIPositionChange(frame,isUnderTouch,status,ptrIndicator);
        }
    }
