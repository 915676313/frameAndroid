...
//
#include "com_arlen_frame_common_utils_JniUtils.h"
#include <string.h>
/*
 * Class:     Java_com_arlen_frame_common_utils_JniUtils
 * Method:    getStringFormC
 * Signature: ()Ljava/lang/String;
 */
JNIEXPORT jstring JNICALL Java_com_arlen_frame_common_utils_JniUtils_getStringFormC
...
jbyteArray Java_com_arlen_frame_common_utils_JniUtils_getKeyValue(JNIEnv *env, jobject obj)
{
...
//JNIEXPORT JNICALL
jbyteArray Java_com_arlen_frame_common_utils_JniUtils_getIv(JNIEnv *env, jobject obj)
{
